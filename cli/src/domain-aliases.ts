...
const aliases: Record<string, DomainAlias> = {
  ...
  'creator.create': { candidates: ['creator.create'], positionalKeys: ['platform', 'profile_ref'] },
  ...
  'creator.runs': { candidates: ['creator.runs.list'] },
  'creator.status': { candidates: ['creator.sync.get'], positionalKeys: ['run_id'] },
  'creator.sync-items': { candidates: ['creator.sync.items.list'], positionalKeys: ['run_id'] },
  'creator.retry': { candidates: ['creator.sync.retry'], positionalKeys: ['run_id'] },
  'creator.cancel': { candidates: ['creator.sync.cancel'], positionalKeys: ['run_id'] },
  'creator.delete': { candidates: ['creator.remove'], positionalKeys: ['source_id'] },
  'ask.sources': { candidates: ['ask.sources.list'] },
  'ask.search': { candidates: ['ask.sources.search'], positionalKeys: ['query'] },
  'ask.create': { candidates: ['ask.thread.create'] },
  'ask.update': { candidates: ['ask.thread.update'], positionalKeys: ['thread_id', 'title'] },
  'ask.delete': { candidates: ['ask.thread.remove'], positionalKeys: ['thread_id'] },
  'ask.starters': { candidates: ['ask.starter_questions'] },
  ...
  'ask.turn': { candidates: ['ask.turn.get'], positionalKeys: ['thread_id', 'turn_id'] },
  'ask.events': { candidates: ['ask.turn.events'], positionalKeys: ['thread_id', 'turn_id'] },
  ...
  'plan.overview': { candidates: ['plan.overview'] },
  'plan.review': { candidates: ['plan.review'] },
  ...
  'plan.apply': { candidates: ['plan.coach.apply'], positionalKeys: ['preview_message_id'] },
  'plan.from-video': { candidates: ['plan.from_library.generate'], positionalKeys: ['note_id', 'instruction'] },
  'plan.focus': { candidates: ['plan.focus.replace'], positionalKeys: ['date'], namedInputKeys: ['tasks'] },
  'plan.task-reorder': { candidates: ['plan.task.reorder'], positionalKeys: ['plan_id'], namedInputKeys: ['task_ids'] },
  ...
  'plan.task-complete': { candidates: ['plan.task.set_completion'], positionalKeys: ['plan_id', 'task_id', 'done'] },
  ...
  'analysis.catalog': { candidates: ['analysis.catalog'] },
  'analysis.runs': { candidates: ['analysis.runs.list'] },
  'analysis.account': { candidates: ['analysis.account.get'] },
  'analysis.delete': { candidates: ['analysis.run.remove'], positionalKeys: ['run_id'] },
  ...
  'platform.bind': { candidates: ['platform.binding.start'], positionalKeys: ['platform'] },
  'platform.status': { candidates: ['platform.binding.status'], positionalKeys: ['platform'] },
  'platform.poll': { candidates: ['platform.binding.poll'], positionalKeys: ['platform', 'session_id'] },
  'platform.disconnect': { candidates: ['platform.binding.disconnect'], positionalKeys: ['platform'] },
