...
const ALL_TABS: TabDef[] = [
  ...
  { key: 'agent', label: 'Agent', href: '/agent', agentMark: true, isActive: (p) => p.startsWith('/agent') },
      ...
      <div className="glass border-t border-card-border/60"
        ...
        <ul className="flex h-16 items-stretch justify-around">
          {ALL_TABS.map((tab) => {
            ...
            const innerClass = `relative flex h-full min-h-11 w-full flex-col items-center justify-center gap-1 px-2 transition-colors duration-150 ${
