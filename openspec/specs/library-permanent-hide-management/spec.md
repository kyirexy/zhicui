# Library Permanent Hide Management Specification

## Purpose

Define explicit permanent hiding, visible management, and recoverable user-scoped visibility controls for synchronized Douyin library items.
